      ...
      <div className="c-container">
        <div class="navbar">
          ...
          <div class="navbar-center menu-social c-nav  hidden lg:flex">
            <ul class="menu menu-horizontal px-1">{link}</ul>
          </div>
          <div className="navbar-end relative z-10">
            <div className={` ${user && "hidden"} flex`}>
              <Link
                to="/login"
                className="btn btn-link no-underline text-[#11224E]"
              >
                Login
              </Link>
              <Link
                to="/register"
                className="btn btn-outline text-[#11224E] bg-[11224E]]"
              >
                Register
              </Link>
            </div>
            ...
            <div
              className={` ${!user && "hidden"} relative z-50`}
              ref={dropdownRef}
            >
