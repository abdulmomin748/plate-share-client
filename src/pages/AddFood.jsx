...
const AddFood = () => {
    ...
    const handleAddFood = e => {
        ...
        console.log(name,email,image, foodName,foodImage,foodQuantity,pickupLocation,additionalNotes);
            ...
            <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8">
                ...
                <div className=" mb-6">
                    ...
                    <input
                        ...
                        className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none" required
                    />
                </div>
                ...
                <div className='mb-5'>
                    ...
                    <DatePicker className='focus:ring-purple-500 w-full p-2' selected={startDate} onChange={(date) => setStartDate(date)} />
                </div>
                {/* Description */}
                <div className="mb-6">
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    rows="4"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none resize-none" required
                    />
                </div>
